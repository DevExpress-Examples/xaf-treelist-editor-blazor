...
using TreeListSample.Blazor.Server.Services;

namespace TreeListSample.Blazor.Server {
    public partial class TreeListSampleBlazorApplication : BlazorApplication {
        public TreeListSampleBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void TreeListSampleBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
